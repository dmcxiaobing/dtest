...
//            name += getChineseCharacter();
    ...
    static String base = "\u96d5\u864e\u7684\u4e00\u4e86\u662f\u6211\u4e0d\u5728\u4eba\u4eec\u6709"
            + "\u6765\u4ed6\u8fd9\u4e0a\u7740\u4e2a\u5730\u5230\u5927\u91cc\u8bf4\u5c31\u53bb"
            + "\u5b50\u5f97\u4e5f\u548c\u90a3\u8981\u4e0b\u770b\u5929\u65f6\u8fc7\u51fa\u5c0f"
            + "\u4e48\u8d77\u4f60\u90fd\u628a\u597d\u8fd8\u591a\u6ca1\u4e3a\u53c8\u53ef\u5bb6"
            + "\u5b66\u53ea\u4ee5\u4e3b\u4f1a\u6837\u5e74\u60f3\u751f\u540c\u8001\u4e2d\u5341"
    ...
    private static String getChineseCharacterFromBook() {
        int random = new Random().nextInt(base.length());
        return String.valueOf(base.charAt(random));
    }


    public static void main(String[] args) {
//        System.out.println(getChineseCharacterFromBook());
        int m = 0;
        for (int i = 0; i < 1000; i++) {
            ++m;
            if (m == 20) {
//                System.out.println(getChineseName());
                System.out.println("郑" + getChineseCharacterFromBook() + getChineseCharacterFromBook());

                m = 0;
            } else {
                System.out.print("郑" + getChineseCharacterFromBook() + getChineseCharacterFromBook() + "   ");
